/**
 * Object representing the configuration for fetching  with a at the moment percentage of where
 * all users are compared to the training requirements.
 * @constant {Object} trainingPercentage
...
export async function trainingPercentage() {
    const payload = {
        resource: 'user',
        fields: [
            'last_name',
